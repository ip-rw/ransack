...
func HasMachines() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
			sqlgraph.To(MachinesTable, FieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, MachinesTable, MachinesPrimaryKey...),
		)
...
func HasMachinesWith(preds ...predicate.Machine) predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
