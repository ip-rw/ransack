...
func (e UserEdges) MachinesOrErr() ([]*Machine, error) {
	if e.loadedTypes[0] {
...
// QueryMachines queries the "machines" edge of the User entity.
func (u *User) QueryMachines() *MachineQuery {
	return (&UserClient{config: u.config}).QueryMachines(u)
}

// QueryKeys queries the "keys" edge of the User entity.
func (u *User) QueryKeys() *KeyQuery {
